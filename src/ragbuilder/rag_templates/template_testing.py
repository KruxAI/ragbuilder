...
top_n_templates= {
    'failedcombo': {
      ...
      'chunking_kwargs': {'chunk_strategy': 'CharacterTextSplitter', 'chunk_size': 1600, 'chunk_overlap': 200}, 
      'vectorDB_kwargs': {'vectorDB': 'chromaDB'}, 
      'embedding_kwargs': {'embedding_model': 'text-embedding-3-large'}, 
      'retriever_kwargs': 
        {'retrievers': 
          [{'retriever_type': 'vectorSimilarity', 'search_type': 'similarity', 'search_kwargs': 5}, {'retriever_type': 'multiQuery', 'search_type': 'similarity', 'search_kwargs': 5}, {'retriever_type': 'parentDocLargeChunk', 'search_type': 'similarity', 'search_kwargs': 5}], 
         'contextual_compression_retriever': True, 
         'document_compressor_pipeline': ['EmbeddingsRedundantFilter', 'EmbeddingsClusteringFilter', 'CrossEncoderReranker'], 
