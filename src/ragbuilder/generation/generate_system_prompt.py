...
#         """
#         Initialize a BestPrompt object with the best prompt template.
        
#         Args:
#             prompt_template (str): The best performing prompt template
#         """
#         self.prompt_text = prompt_template  # Store the full prompt text
#         self.retriever = None
#         self.llm = None
#         self.pipeline = None
...
#             raise ValueError("Retriever and LLM must be set before creating pipeline")
...
#             prompt = ChatPromptTemplate.from_messages(
#                 [
#                     ("system", self.prompt_text),  # Use stored prompt text
#                     ("user", "{question}"),
#                     MessagesPlaceholder(variable_name="chat_history", optional=True),
#                 ]
#             )
...
#         except Exception as e:
#             import traceback
#             print(f"An error occurred while creating pipeline: {e}")
#             traceback.print_exc()
#             return None
    
#     def invoke(self, question, chat_history=None):
#         """
#         Invoke the RAG pipeline with a given question.
...
#         # Prepare input with optional chat history
#         input_dict = {"question": question}
#         if chat_history is not None:
#             input_dict["chat_history"] = chat_history
        
#         return self.pipeline.invoke(input_dict)